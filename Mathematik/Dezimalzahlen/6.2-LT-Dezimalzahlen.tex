...
\begin{document}
	...
	\begin{loesungskarte}
		\begin{enuma}
			\item $29,7 : 21\approx 1,4143$
			\item \begin{description}
				\item[A0] Breite: \SI{84,1}{\centi\meter}, Höhe: \SI{118,9}{\centi\meter}
				\item[A8] Breite: \SI{5,2}{\centi\meter}, Höhe: \SI{7,4}{\centi\meter}
			\end{description}
			\item $\SI{585,9}{\square\centi\meter}§
		\end{enuma}
	\end{loesungskarte}

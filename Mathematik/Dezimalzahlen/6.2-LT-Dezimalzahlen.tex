...
%	\end{loesungskarte}
	...
	\begin{karte3}{Spickzettel}
		\hinweis{Bearbeite diese Karte erst, wenn du die grünen Karten fertig hast.}
	...
	\begin{karte3}[\symPartner]{Checker}
		...
		\begin{enumerate}
			...
			\begin{tabular}{c|c|c}
				...
				Brüche in Dezimalzahlen umformen & \Large\usym{1F604}\xspace\usym{1F642}\xspace\usym{1F610}\xspace\usym{1F641} & \cdots \hline
				& & & 
			\end{tabular}
		\end{enumerate}
	\end{karte3}

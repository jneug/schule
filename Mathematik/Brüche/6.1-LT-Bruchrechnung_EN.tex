...
\NewDocumentCommand \tikzAnteile {s >{\SplitArgument{1}{,}}D(){0,0} >{\SplitArgument{1}{,}}o m m m} {%
	\IfNoValueTF{#3}{%
		\IfBooleanTF{#1}{%
			\@tikzAnteileZeichnen #2 {#5} {#4} {#5} {#4} {#6}
		}{%
			\@tikzAnteileZeichnen #2 {#4} {#5} {#4} {#5} {#6}
		}
	}{%
		\IfBooleanTF{#1}{%
			\@tikzAnteileZeichnen #2 #3 {#5} {#4} {#6}
		}{%
...
\begin{document}
	\begin{hilfekarte}{Bruchzahlen}{bruchzahlen}
		...
		For example \enquote{3 von 4} $= \frac{3}{4} =$ \begin{tikzpicture}[baseline=-3pt,scale=.5]\tikzAnteileKreis{3}{4}\end{tikzpicture}
		...
		We divide \emph{the whole} into so many parts of equal size, as 
	...
	\begin{hilfekarte}{Kürzen und erweitern}{kuerzen}
		...
		\begin{multicols}{2}
			...
			\begin{center}
				\begin{tikzpicture}[scale=.5,baseline=3mm]
				\tikzAnteile*{2}{5}{2}{4}{3}
				\end{tikzpicture} = \begin{tikzpicture}[scale=.5,baseline=3mm]
				\tikzAnteile*{2}{5}{8}{4}{12}
				\end{tikzpicture}
			\end{center}
		\end{multicols}
	\end{hilfekarte}
	...
	\begin{hilfekarte}{Brüche addieren und subtrahieren}{addition}
		...
		\begin{multicols}{2}
			...
			\begin{center}
				\begin{tikzpicture}[scale=.5,baseline=3mm]
				\tikzAnteile{2}{3}{2}{3}{1}
				\end{tikzpicture} + \begin{tikzpicture}[scale=.5,baseline=3mm]
				\tikzAnteile{2}{3}{2}{3}{4}
				\end{tikzpicture} = \begin{tikzpicture}[scale=.5,baseline=3mm]
				\tikzAnteile{2}{3}{2}{3}{5}
				\end{tikzpicture}
			\end{center}
		\end{multicols}
		\vspace{1cm}
		...
		\begin{center}
			\begin{tikzpicture}[scale=.5,baseline=6mm]
			\tikzAnteile{3}{4}{3}{4}{6}
			\end{tikzpicture} + \begin{tikzpicture}[scale=.5,baseline=6mm]
			\tikzAnteile*{3}{4}{2}{4}{3}
			\end{tikzpicture} = \begin{tikzpicture}[scale=.5,baseline=6mm]
			\tikzAnteile{3}{4}{3}{8}{12}
			\end{tikzpicture} +  \begin{tikzpicture}[scale=.5,baseline=6mm]
			\tikzAnteile*{3}{4}{3}{8}{9}
			\end{tikzpicture} = \tikz[scale=.5,baseline=6mm]{%
			\tikzAnteile*{3}{4}{3}{8}{21}}
		\end{center}
...
%	\end{loesungskarte}
	...
	\begin{karte1}{Anteile bestimmen}\hilfeMarke{bruchzahlen}
		\begin{enumerate}
			\item \begin{tasks}(5)
			...
			\item \begin{tasks}(5)
				...
				\task \begin{tikzpicture}[baseline=(current bounding box.north),scale=.75]
					\tikzAnteile{4}{3}{0}
...
%	\begin{karte1}{Anteile erkennen}
%		\hilfeMarke{bruchzahlen}
%		Notiere zu jedem Bild den gefärbten Anteil als Bruch.
%	\end{karte1}

%	\begin{karte1}{Kürzen und erweitern}\hilfeMarke{kuerzen}
%		Kürze und erweitere wie angegeben.
%	\end{karte1}
	
%	\begin{karte2}{Kürzen und erweitern II}\hilfeMarke{kuerzen}
%		Bringe alle Brüche auf denselben \emph{Nenner}.
%	\end{karte2}

...
\begin{document}
	...
	\begin{aufgabe}
		...
		\begin{enumeratea}
			...
			\item \operator{Berechnen} sie die Höhe des Deiches.
			\item Welches ist die Landseite, welches die Seeseite des Deiches? \operator{Begründen} sie ihre Meinung.
			\item \operator{Bestimmen} sie das Volumen des Deiches auf einer Länge von \SI{100}{\meter}.
	...
	\begin{aufgabe}
		...
		\begin{enumeratea}
			...
			\item \operator{Beschreiben}  Sie den Verlauf des Graphen von $f$ für große Werte von $t$ und inter-
	...
	\begin{aufgabe}
		...
		\begin{smallenumerate}
			...
			\item Am Ladegerät wird der Ladezustand des Akkus mit Balken angezeigt. Bei einem Balken beträgt die Ladung weniger als \prozent{30}. Bei zwei Balken zwischen \prozent{30} und \prozent{60}. \operator{Bestimmen} Sie nach wie vielen Minuten der erst Balken angezeigt wird.

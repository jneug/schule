...
\begin{aufgabe}[symbol=\symPartner\,\symLaptop]
	...
	\includegraphics[width=3cm]{Q2-AB.X.2-ABB_S3-Logo.png}
	\end{wrapfigure}
	...
	\begin{teilaufgaben}
		\teilaufgabe
		Erstelle einen neuen \code{SuperSecureServer} und probiere dich Anmeldung. Die Datenbank mit Nutzerkonten ist im Projektordner unter dem Namen \datei{auth.db} gespeichert.

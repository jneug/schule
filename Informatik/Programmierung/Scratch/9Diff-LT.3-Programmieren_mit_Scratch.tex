...
\begin{karte2}{Nachrichten}
	...
	Ergänze dann eine \code{stopp} Nachricht, die bei einer anderen Taste gesendet wird und dei Tänzer stoppen lässt.
\end{karte2}

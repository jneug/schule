...
\begin{aufgabe}
	Erstelle eine Instanz des \code{DescisionTreeBuilder}s und führe die Methode \code{calculateEntropie()} aus. Vergleiche die angezeigten Daten mit der berechneten \emph{Entropie} und dem \emph{Informationsgewinn} der Attribute.
\end{aufgabe}
...
\begin{aufgabe}
	...
	Implementiere die Methode \code{private void printTree( BinaryTree<DecisionNode> pBaum, int pTiefe )} (Zwilw 84) wie folgt:

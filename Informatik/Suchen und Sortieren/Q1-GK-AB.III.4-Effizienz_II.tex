...
\begin{aufgabe}
	Implementiert eine Methode \code{public void time( int n )}, die ein Array mit
	...
	\code{System.out.println(n+"$\backslash$t"+time);}

	wobei \code{n} die Anzahl der sortierten Elemente ist und
	\code{time} die gemessene Zeit. \code{$\backslash$t} erzeugt einen

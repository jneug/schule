...
\begin{aufgabe}[icon=\iconPartner\ \iconHeft]
	...
	\begin{tikzpicture}[pap]
		...
		\node[verzweigung, kommando, below=of s1] (v1) {isz 2};
		\node[aktion, kommando, below=of v1] (a1) {{dec 2}};
		\node[verzweigung, kommando, right=of v1] (v2) {isz 1};
		\node[aktion, kommando, below=of v2] (a2) {{dec 1}};
		\node[aktion, kommando, below=of a2] (a3) {{inc 2}};
		\node[aktion, kommando, below=of a3] (a4) {{inc 2}};
		\node[startstop, kommando, right=of v2] (e1) {{stp}};

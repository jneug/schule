...
\begin{aufgabe}[symbol=\symLaptop]
	\begin{itemize}
		\item Kopiere den Ordner \directory{KnowHowPC} aus dem Tauschordner in deinen Bereich und starte das Programm \texttt{KnowHowPC.exe}.
		\item Öffne über \menu{Datei>Öffnen} das Programm \enquote{\texttt{Erstes Programm.khp}}.
